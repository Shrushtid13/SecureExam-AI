          ...
          <div className="left-panel">
            ...
            <div className="left-content">
              ...
              <p className="welcome-text">
                SecureExam AI hashes all passwords using bcrypt. Choose a strong, unique password for your account.
              </p>
            </div>
          </div>
            ...
            <div className="right-content">
              ...
              {status.message && (
                <div style={{ 
                  ...
                  {status.message}
                  {status.type === 'success' && <div style={{marginTop: '0.5rem', fontSize: '0.65rem'}}>Redirecting to login...</div>}
                </div>
              )}
              ...
              <p className="signup-text">
                <Link to="/login" className="signup-link">Return to Sign In</Link>
              </p>
            </div>
          </div>
        </div>
